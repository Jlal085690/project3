...
if tonumber(Message_Reply.sender_id.user_id) == tonumber(7432544274) then
return bot.sendText(msg_chat_id,msg_id,"*لا استطيع استخدام الأمر علي جلال بيه*","md",true)  
end
