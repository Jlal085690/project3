...
xname =  (Redis:get(Fast.."Name:Bot") or "[ . 𝑱𝑳𝑨𝑳]") 
...
if text == 'جلالبيه يبني' or text == 'بنك مين يبني' then
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ جلال ماعندها حساب بالبنك 🤣","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"\n*← جلال معندهوش حساب بالبنك 🤣*","md",true)  
return false
end
...
send(msg.chat_id,msg.id, "⌯ حوالة صادرة من بنك جلال\n\n⇜ المرسل : "..news.."\n⇜ الحساب رقم : `"..cccc.."`\n⇜ نوع البطاقة : "..uuuu.."\n⇜ المستلم : "..newss.."\n⇜ الحساب رقم : `"..text.."`\n⇜ نوع البطاقة : "..fsvhh.."\n⇜ خصمت 10% رسوم تحويل\n⇜ المبلغ : "..convert_mony.." جنيه 💵","md",true)
send(fsvhhh,0, "⌯ حوالة واردة من بنك جلال\n\n⇜ المرسل : "..news.."\n⇜ الحساب رقم : `"..cccc.."`\n⇜ نوع البطاقة : "..uuuu.."\n⇜ المبلغ : "..convert_mony.." جنيه 💵","md",true)
Redis:del(Fast.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(Fast.."transn" .. msg.sender_id.user_id)
else
...
local nadebott = {"اشبيلية", "ريفر بلايت", "ريفر بلايت", "بوروسيا", "أياكس الهولندي", "ليون", "شاختار دونيتسك", "روما", "فياريال", "بوكا جونيورز", "نابولي", "بنفيكا", "فلامنجو", "ليستر سيتي", "بالمرسي", "ليل", "ريال سوسيداد", "ايندهوفن", "الأهلي المصري", "الجلالالسعودي", "الاتحاد السعودي",}
...
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⌯ اهلا فيك بمزرعة جلال :\n\n⇜ المزروعات واسعارها :\n- بطاطا : 75 جنيه 💵\n- بندوره : 100 جنيه 💵\n- خس : 125 جنيه 💵\n- خيار : 150 جنيه 💵\n- جزر : 175 جنيه 💵\n- فليفله : 200 جنيه 💵\n- فريز : 300 جنيه 💵\n- ذره : 400 جنيه 💵\n- ثوم : 500 جنيه 💵\n- فطر : 800 جنيه 💵\n- شجره تفاح : 1000 جنيه 💵\n- شجره عنب : 1250 جنيه 💵\n-شجره زيتون : 1500 جنيه 💵\n- شجره موز : 2000 جنيه 💵\n- شجره مانجا : 3000 جنيه 💵\n\n⇜ مثال طريقة الزراعه : \n- زراعه بطاطا 10\n- زراعه شجر موز 15\n⧫","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@swc_t")
sleep(1)
