...
ControllerAll = false
local ListSudos = {Sudo_Id,7432544274,7432544274,7432544274,7432544274,6430417482,7432544274,7432544274}
...
if UserId == 7432544274 then
Status = true
elseif UserId == 7432544274 then
Status = true
elseif UserId == 7432544274 then
Status = true
elseif UserId == 7432544274 then
...
elseif tonumber(Message) < 74325442741 then 
...
xname =  (Redis:get(Fast.."Name:Bot") or "[جلال]") 
...
if tonumber(senderr) == 7432544274 then
msg.Name_Controller = 'المبرمج جلال ❤️‍🔥  '
msg.The_Controller = 1
elseif tonumber(senderr) == 5092041118 then
msg.Name_Controller = 'مطور السورس - ✅ '
msg.The_Controller = 1
elseif tonumber(senderr) == 7432544274 then
msg.Name_Controller = 'مطور السورس - ✅ '
msg.The_Controller = 1
...
msg.The_Controller = 1
elseif tonumber(senderr) == 7432544274 then
msg.Name_Controller = 'ستك . يقلب امك 🌝🤍 '
msg.The_Controller = 1
elseif tonumber(senderr) == 7432544274 then
...
if msg.sender_id.user_id == tonumber(7432544274) then
send(msg_chat_id,msg_id,"مرحبآ بك عزيزي المبرمج جلال نورت الجروب - 🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(6430417482) then
send(msg_chat_id,msg_id,"آهلا بيك عزيزتي المبرمجه . ملكه السورس ❤️‍🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(7432544274) then
...
if idephoto then
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "[جلال]")
...
local name_amr = bot.getUser(7432544274).first_name.." "..bot.getUser(7432544274).last_name
local name_parlo = bot.getUser(7432544274).first_name.." "..bot.getUser(7432544274).last_name
local caption = "اليك قائمه مطورين سورس جلال :"
if tonumber(UserId_Info.id) ~= 7432544274 then
...
data = {
{
{text = name_amr, data = msg.sender_id.user_id..'/DevShow@7432544274'},
},
{
{text = name_parlo, data = msg.sender_id.user_id..'/DevShow@7432544274'},
},
LocalDev
,
{
...
return send(msg.chat_id, msg.id,"الرابط خطأ \nارسل الرابط بالشكل ده كمثال : https://t.me/swc_t ", 'md', true)
end
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(7432544274) then
...
if text == '.' or text == '♕  جلال ' then
photo = "https://t.me/merat_caser"
local T =[[
[ٓ  دي .  يقلب امك ♕  صاحب السورس يقلبي❤️‍🔥 ˼ 𓆪 𓆃](t.me/merat_caser )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ MRAET . 𝑱𝑳𝑨𝑳 › .', url = "https://t.me/merat_caser"}
},
{
{text = ' ⛥. 𝑱𝑳𝑨𝑳⛥ ', url = "https://t.me/swc_t"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'جلال' or text == 'المبرمج جلال' then
photo = "https://t.me/swc_t"
local T =[[
...
{
{text = '‹ ٰ𖣂 • BOT . 𝑱𝑳𝑨𝑳 • 𖣂 ›', url = "https://t.me/caserbotbot"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'المبرمج' or text == 'جلال' or text  == 'المبرمج جلال' then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
bot.sendText(7432544274,0,'*\n◉  مرحباً عزيزي المبرمج جلال \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ𝐒𝐎𝐔𝐑𝐂𝐄  𝑱𝑳𝑨𝑳,━━━━⩺ \n◉  اسمه :- '..klajq..' \n◉  ايديه :-  : '..msg.sender_id.user_id..'\n◉  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'فوفا' or text == 'فراولا'  then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
...
if msg.sender_id.user_id == tonumber(7432544274) then
send(msg_chat_id,msg_id,"❍ انت جلال مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(7432544274) then
send(msg_chat_id,msg_id,"❍ 🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(7432544274) then
send(msg_chat_id,msg_id,"❍ انت مانو مطور السورقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(7432544274) then
send(msg_chat_id,msg_id," ♥","md",true)
elseif msg.sender_id.user_id == tonumber(7432544274) then
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(7432544274) then
local txx = "\n"
...
type = 'inline',
data = {
{{text = 'البصرة 🇮🇶', data = msg.sender_id.user_id..'/azan/cairo'},{text = 'البصرة 🇸🇦', data = msg.sender_id.user_id..'/azan/Makkah'},{text = 'بغداد 🇮🇶', data = msg.sender_id.user_id..'/azan/Baghdad'},},
{{text = '- 𝐒𝐎𝐔𝐑𝐂𝐄  𝑱𝑳𝑨𝑳 •', url = "https://t.me/swc_t"}},
}
}
local Msg_text = "مواقيت الصلاه حسب التوقيت المحلي لمدينه البصرة 🇮🇶\n=================\n- الفجر : "..timings.Fajr.."\n- الظهر : "..timings.Dhuhr.."\n- العصر : "..timings.Asr.."\n- المغرب : "..timings.Maghrib.."\n- العشاء : "..timings.Isha.."\n=================\n"..date.weekday.ar.." ,"..date.day.." من "..date.month.ar.." "..date.year
...
return send(msg_chat_id,msg_id,'\n⌯ مرحبا بك في السجل المدني الخاص بسورس . 𝑱𝑳𝑨𝑳\nاكتب اسمك الان :',"md",true)  
end
...
"هل سبق ورسبت في المدرسة؟ وكم عدد ال♕ ؟",
...
keyboardd.inline_keyboard = {
{
{text = 'قناة السورس', url = "https://t.me/swc_t"}
},
}
local msg_id = msg.id/2097152/0.5
...
if text == (Redis:get(Fast.."Name:Bot") or "جلال") then
local photo = bot.getUserProfilePhotos(Fast)
if photo.total_count > 0 then
local NamesBot = (Redis:get(Fast.."Name:Bot") or "جلال")
local Mostafa = {
'• مالك حبيبى 🥺',
...
if text == 'جلال' or text == 'مبرمج السورس' or text == 'caesar' then  
...
keyboardd.inline_keyboard = {
{
{text = '❲ المبرمج جلال ❳', url = "https://t.me/swc_t"}
},
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄  𝑱𝑳𝑨𝑳', url = "https://t.me/swc_t"},
},
...
data = {
{
{text = '𓆩 ˹ [𝐒𝐎𝐔𝐑𝐂𝐄  𝑱𝑳𝑨𝑳] ˼ 𓆪', url = "https://t.me/swc_t"}
},
}
}
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
...
local Name_dev = bot.getUser(Sudo_Id).first_name
local UName_dev = bot.getUser(Sudo_Id).username
local CmdStart = '*\n🤖╖ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "[جلال]")..
...
'\n📣╢• ــــــــــــــــــــ𝐒𝐎𝐔𝐑𝐂𝐄  𝑱𝑳𝑨𝑳ــــــــــــــــ '..
'\n📣╢• تأكد » من تفعيل الرفع '..
